...
We use 70 tesseract files from 5 groups as our training set.
```{r}
train_file_id <- c(1:7, 11:30, 39:40, 42:60, 69:90)
...
We use the rest 30 tesseract files of tokens as the test data.

```{r test svm}
test_file_id <- c(8:10, 31:38, 41, 61:68, 91:100)
...
OCR_performance_table["word_wise_recall","Tesseract"] <- length(old_intersect_vec)/num_test_truth_list
OCR_performance_table["word_wise_precision","Tesseract"] <- length(old_intersect_vec)/num_test_tokens_list
OCR_performance_table["word_wise_recall","Tesseract_with_postprocessing"] <- length(new_intersect_vec2)/num_test_truth_list
OCR_performance_table["word_wise_precision","Tesseract_with_postprocessing"] <- length(new_intersect_vec2)/num_test_tokens_list
